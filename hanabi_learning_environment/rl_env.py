...
class HanabiEnv(Environment):
  ...
  """
    ...
    def __init__(self, config, game=None, state=None):
    ...
    def copy(self):
        return HanabiEnv(None, self.game, self.state)
...
def make(environment_name="Hanabi-Full", num_players=2, pyhanabi_path=None):
  ...
  """
    ...
    if (environment_name == "Hanabi-Full" or
            environment_name == "Hanabi-Full-CardKnowledge" or
            environment_name == "hanabi"):
        return HanabiEnv(
            config={
                "colors":
                    5,
